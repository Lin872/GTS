...
function showButtonProfileUpload() {
    ...
    $btnUpload.click (function() {
        ...
        let profile = {
            ...
            'heroHelmet': getItemValue($playerProfile.find('.heroItem.helmet .item').attr('class').match(/(item\d+)/)[1]),
            'heroBody': getItemValue($playerProfile.find('.heroItem.body .item').attr('class').match(/(item\d+)/)[1]),
            'heroShoes': getItemValue($playerProfile.find('.heroItem.shoes .item').attr('class').match(/(item\d+)/)[1]),
            'heroLeftHand': getItemValue($playerProfile.find('.heroItem.leftHand .item').attr('class').match(/(item\d+)/)[1]),
            'heroRightHand': getItemValue($playerProfile.find('.heroItem.rightHand .item').attr('class').match(/(item\d+)/)[1]),
            'heroHorse': getItemValue($playerProfile.find('.heroItem.horse .item').attr('class').match(/(item\d+)/)[1]),
            'villages': villages
        };
